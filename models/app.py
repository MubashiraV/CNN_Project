...
def preprocess_image(image):
    ...
    return image_array.reshape(1, 150, 150, 3)  # Add batch dimension
...
st.set_page_config(
    page_title="Cat vs Rabbit Classification",
    page_icon="💡",
    # layout="wide",
...
<div class="gradient-text">Cat vs Rabbit classification</div>
"""

st.markdown(gradient_text_html, unsafe_allow_html=True)
st.image(r'C:\Users\Guest!\Documents\models\cat vs rabbit.jpeg', width=700)
st.subheader("**Is it a cat or a rabbit?** Upload an image to find out!")
